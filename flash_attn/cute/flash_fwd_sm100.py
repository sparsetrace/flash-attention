...
from flash_diffusion.cute.paged_kv import PagedKVManager
from flash_diffusion.cute.cute_dsl_utils import assume_tensor_aligned
from flash_diffusion.cute import utils
import flash_diffusion.cute.pipeline as pipeline_custom
import cutlass.pipeline as cutlass_pipeline
from flash_diffusion.cute.mask import AttentionMask
from flash_diffusion.cute.softmax import SoftmaxSm100, apply_score_mod_inner
from flash_diffusion.cute.seqlen_info import SeqlenInfoQK
from flash_diffusion.cute.block_info import BlockInfo
from flash_diffusion.cute.block_sparsity import BlockSparseTensors
from flash_diffusion.cute.block_sparse_utils import (
    get_total_block_count,
    produce_block_sparse_loads_sm100,
    softmax_block_sparse_sm100,
    handle_block_sparse_empty_tile_correction_sm100,
)
from flash_diffusion.cute.pack_gqa import PackGQA, pack_gqa_layout
from flash_diffusion.cute import mma_sm100_desc as sm100_desc
from flash_diffusion.cute import blackwell_helpers as sm100_utils
from flash_diffusion.cute.named_barrier import NamedBarrierFwdSm100
from cutlass.cute import FastDivmodDivisor
from quack.cute_dsl_utils import ParamsBase
from flash_diffusion.cute.tile_scheduler import (
    ClcState,
    SchedulingMode,
...
from flash_diffusion.cute.fa_logging import fa_log, fa_printf
from flash_diffusion.cute.utils import smid
...
class FlashAttentionForwardSm100:
    ...
    def softmax_loop(
        ...
        while work_tile.is_valid_tile:
            ...
            # ------------------------------------------------------------------
            # col_bias: hoist all per-work-tile preparation here so softmax_step
            # (called once per n_block) only does cheap local_tile + FP32 adds.
            #
            # We compute:
            ...
            if const_expr(col_bias is not None):
                ...
                if const_expr(col_bias_rank == 3):
                    ...
                    col_bias_seq = col_bias  # (seqlen_k,) — no copy, just alias

                # --- 2. varlen offset (branch folds at compile time) ---
    ...
    def softmax_step(
        ...
        Ordering within one step:
          ...
          3. col_bias add   — tSrS_t2r[k] += col_bias_seq[n_block*N + n_coord(k)]
